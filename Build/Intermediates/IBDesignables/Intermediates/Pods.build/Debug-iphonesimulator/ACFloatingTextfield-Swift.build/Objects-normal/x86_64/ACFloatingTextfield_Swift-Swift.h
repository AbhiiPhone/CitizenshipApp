...
SWIFT_CLASS("_TtC25ACFloatingTextfield_Swift19ACFloatingTextfield")
@interface ACFloatingTextfield : UITextField
/// Disable Floating Label when true.
@property (nonatomic) BOOL disableFloatingLabel;
/// Shake Bottom line when Showing Error ?
@property (nonatomic) BOOL shakeLineWithError;
...
@property (nonatomic, strong) UIColor * _Nonnull selectedPlaceHolderColor;
...
- (void)showError;
- (void)hideError;
- (void)showErrorWithTextWithErrorText:(NSString * _Nonnull)errorText;
@end


@interface ACFloatingTextfield (SWIFT_EXTENSION(ACFloatingTextfield_Swift))
@end


@interface UIView (SWIFT_EXTENSION(ACFloatingTextfield_Swift))
@end
