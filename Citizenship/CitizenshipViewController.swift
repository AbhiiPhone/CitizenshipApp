...
//    expanded: false),
   ...
   // let targetArray : [Dictionary<String, String>] = [
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        cell.queNewLbl.text = ansArray[indexPath.row]
        cell.headingLbl.text = titleArray[indexPath.row]
        
        self.testTableVw.separatorColor = UIColor.clear
